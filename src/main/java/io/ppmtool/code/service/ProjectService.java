...
public class ProjectService {
	...
	public Project findByProjectIdentifier(String projectId,String username) {
		...
		if(project == null) {
			throw new ProjectIdException("Cannot delete this Project Id" +projectId +" does not exists");
		}
	...
	public void deleteProjectByIdentifier(String projectId,String username) {
		...
		projectRepository.delete(this.findByProjectIdentifier(projectId, username));
	}
